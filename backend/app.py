...
def lookup():
    ...
    csv_code3 = three_letter_from_name_or_code(base_name, base_code)
    ...
    # NEW: clean NaN-like floterials in the response (no other changes)
    ...
    resp = {
        ...
        "issues": issues_out,
        "vote_columns": [i["slug"] for i in issues_out],
        "reps": reps
    }
    if want_debug:
        resp["debug"] = {
